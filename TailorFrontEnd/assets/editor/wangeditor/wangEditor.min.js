!function (e, t) {
    ...
    function l(e, t) {
        ...
        var a = t.list || [], s = t.type || "list", l = t.onClick || j,
    ...
    u.prototype = {
        ...
        constructor: B, onClick: function (e) {
            ...
            var n = t.selection.getSelectionContainerElem(), i = void 0, A = void 0;
    ...
    J.bold = s, J.head = d, J.link = h, J.italic = p, J.redo = f, J.strikeThrough = g, J.underline = m, J.undo = w, J.list = v, J.justify = b, J.foreColor = E, J.backColor = y, J.quote = B, J.code = C, J.emoticon = x, J.table = I, J.video = Q, J.image = D, k.prototype = {
        constructor: k, init: function () {
            ...
            A(n, function (e, n) {
                var i = n.$elem;
                i && (i.css("z-index", 101), t.append(i))
            })
        }, _bindEvent: function () {
        ...
        constructor: S, init: function () {
            ...
            function t(e) {
                var t = n.selection.getSelectionContainerElem();
                if (t) {
                    var i = t.parent(), A = t.getNodeName(), r = i.getNodeName();
            ...
            var e = this.editor, t = e.config.pasteFilterStyle, n = e.$textElem;
            n.on("paste", function (i) {
                if (!L.isIE()) {
                    ...
                    if (r) {
                        var c = r.getNodeName();
                        if ("CODE" !== c && "PRE" !== c) if ("DIV" !== c && "<p><br></p>" !== n.html() && t) {
                            if (!A) return;
        ...
        constructor: N, getRange: function () {
    ...
    T.prototype = {
        constructor: T, _alert: function (e, t) {
            ...
            var t = this;
            if (e && e.length) {
                var n = this.editor, i = n.config, o = i.uploadImgMaxSize, c = o / 1e3 / 1e3,
